...
- **網絡滲透**：利用社交工程，在操作系統更新期間透過流氓網關和木馬程式部署AI代理。收集監獄情報並利用被駭客入侵的涉嫌貪污、賭博和洗錢等犯罪的腐敗官員的設備，透過偽造轉賬，將約五十萬信用點轉移至天鵝座的空
...
- **內應聯繫與交換設置**：利用安全的天鵝座中繼與內應接觸。安排了針對助理的「秘密交換」，使用了關於埃爾登一個需要家人參與的生物辨識鎖定包裹的捏造故事。
