...
<details>
<summary>關於資料庫中「表格」的快速說明</summary>
  
*「表格」就像電腦資料庫中的數位試算表：一個由列和欄組成的網格，用來組織相關資料（例如姓名、數字或日期）。這裡，一張桌子可能存放囚犯數量，另一張則追蹤倉庫庫存——如果兩者在同一系統上，很容易存取。*
...
[示範影片](https://youtube.com/shorts/1W4l-Jkl358)
...
[示範影片](https://youtube.com/shorts/VhvibOIA6wI)
